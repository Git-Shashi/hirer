...
function LandingPage() {
    ...
    <main className='flex flex-col gap-10 sm:gap-20 py-10 sm:py-20'>
      <section className='text-center'>
        <h1 className='flex flex-col items-center justify-center gradient-title text-4xl font-extrabold sm:text-6xl lg:text-8xl tracking-tighter py-4' >Find your dream job 
          <span className='flex items-center gap-2 sm:gap-6'>& get <img src="/logo.png" alt="Hired logo "  className='h-14 sm:h-24 lg:h-32'/></span></h1>
  ...
  <CardContent>
    <p>Search and apply for jobs , track application and many more</p>
  </CardContent>
